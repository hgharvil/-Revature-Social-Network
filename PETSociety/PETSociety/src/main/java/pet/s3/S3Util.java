...
/**
 * Helper class to push data to the s3 instance
 * @author Emmanuel
 */
public class S3Util {
	private static final String BUCKET = "petsocietyproject2";
	...
	public static String uploadFile(String fileName, InputStream inputStream) 
		...
		return ConstantUtils.END_POINT_URL+"/"+ConstantUtils.BUCKET_NAME+"/"+fileName;
	}
}
